...
% Expectations, highest female, highest male
...
% Job titles that were unbiased in both datasets were \textit{server} (felszolgáló/\textit{服务员}), and \textit{student} (diák/\textit{学生}). 
