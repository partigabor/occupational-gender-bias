...
\noindent--- Chinese only marks gender when writing the 3rd person singular pronoun -- \zh{他} \textit{tā} `he' / \zh{她} \textit{tā} `she' -- but that too is a relatively recent invention (?), and similarly to Hungarian, most occupations are unmarked for gender.
...
\hl{--- Mention some ``default is masculine'' theory if exists...? Languages with many genders?}
