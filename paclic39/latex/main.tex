...
In recent years however, documentation of gender bias has been extented to other languages as well, such as Lithuanian, Icelandic, and Polish, also including languages without grammatical gender like Chinese, Japanese, and Thai \citep[][]{hellinger_2003_gender,pauwels_2003_linguistic}. Most recently, \citeposs{kaukonen_2025_gender} work compared Estonian and Russian, where the former lacks grammatical gender.
