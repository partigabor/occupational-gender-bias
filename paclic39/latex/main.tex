...
% Figure on the whole page, across both columns, showing the mean ratings of occupations in Hungarian.

\begin{figure*}[ht]
  \centering
  \includegraphics[width=\linewidth]{../occupations_hu}
  \caption{Mean ratings of occupational titles in Hungarian.}
